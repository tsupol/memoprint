...
<script type="text/javascript" src="{{ asset('/plugins/bootstrap-wysiwyg/js/wysihtml5-0.3.0.min.js') }}"></script>
<script type="text/javascript" src="{{ asset('/plugins/bootstrap-wysiwyg/js/bootstrap-wysihtml5-0.0.2.js') }}"></script>
...
<script src="{{ asset('/http://blueimp.github.io/JavaScript-Load-Image/js/load-image.min.js') }}"></script>
<!-- The Canvas to Blob plugin is included for image resizing functionality -->
<script src="{{ asset('/http://blueimp.github.io/JavaScript-Canvas-to-Blob/js/canvas-to-blob.min.js') }}"></script>
