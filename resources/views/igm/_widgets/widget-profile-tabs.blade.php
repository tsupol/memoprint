              ...
              <div class="content-list">
                <div data-rel="scroll">
                  <ul  class="list-wrapper">
                    ...
                    <li>  <span class="menu-icon vd_green"><img alt="example image" src="{{ asset('/img/avatar/avatar.jpg') }}"></span> <span class="menu-text"> Change Profile Pic <span class="menu-info"><span class="menu-date"> ~ 20 Days Ago</span></span> </span> </li>
                    <li>  <span class="menu-icon vd_red"><i class=" fa fa-cogs"></i></span> <span class="menu-text"> Your setting is updated <span class="menu-info"><span class="menu-date"> ~ 12 Days Ago</span></span> </span>  </li>
                    <li>  <span class="menu-icon vd_green"><i class=" fa fa-book"></i></span> <span class="menu-text"> Added new article <span class="menu-info"><span class="menu-date"> ~ 19 Days Ago</span></span> </span> </li>
                    <li>  <span class="menu-icon vd_green"><img alt="example image" src="{{ asset('/img/avatar/avatar.jpg') }}"></span> <span class="menu-text"> Change Profile Pic <span class="menu-info"><span class="menu-date"> ~ 20 Days Ago</span></span> </span>  </li>
                  </ul>
    	...
    	<div class="pd-20">
				...
				<table class="table table-striped table-hover">
							  ...
							  <tbody>
								<tr>
                                	<td>1</td>
									<td><img height="80" src="{{ asset('/img/avatar/avatar.jpg') }}" alt="example image"></td>                    
                                	<td>Zoe Corp </td>                                    
								...
								<tr>
                                	<td>2</td>
									<td><img height="80" src="{{ asset('/img/avatar/avatar-2.jpg') }}" alt="example image"></td>                    
                                	<td>Zoe Corp </td>                                    
									<td class="center">2010/02/03</td>
									<td class="center">
										<span class="label label-success">Finish</span>
								...
								<tr>
                                	<td>3</td>
									<td><img height="80" src="{{ asset('/img/avatar/avatar-3.jpg') }}" alt="example image"></td>                    
                                	<td>Zoe Corp </td>                                    
									<td class="center">2010/02/03</td>
									<td class="center">
										<span class="label label-success">Finish</span>
								...
								<tr>
                                	<td>4</td>
									<td><img height="80" src="{{ asset('/img/avatar/avatar-4.jpg') }}" alt="example image"></td>                    
                                	<td>Zoe Corp </td>                                    
									<td class="center">2010/02/03</td>
									<td class="center">
										<span class="label label-success">Finish</span>
								...
								<tr>
                                	<td>5</td>
									<td><img height="80" src="{{ asset('/img/avatar/avatar-5.jpg') }}" alt="example image"></td>                    
                                	<td>Zoe Corp </td>                                    
									<td class="center">2010/02/03</td>
									<td class="center">
										<span class="label label-success">Finish</span>
                ...
                <div class="isotope js-isotope vd_gallery">
                  <div class="gallery-item  filter-1">                    	 
                  	<a href="img/photos/01.jpg" data-rel="prettyPhoto[2]"> 
                    		<img alt="example image" src="{{ asset('/img/photos/01.jpg') }}">
                  ...
                  <div class="gallery-item  filter-2">                  	
                      <a href="img/photos/03.jpg" data-rel="prettyPhoto[2]"> 
                                <img alt="example image" src="{{ asset('/img/photos/03.jpg') }}">
                                <div class="bg-cover"></div> 
                        </a> 
                         <div class="vd_info">
                  ...
                  <div class="gallery-item  filter-2">
                      <a href="img/photos/08.jpg" data-rel="prettyPhoto[2]"> 
                                <img alt="example image" src="{{ asset('/img/photos/08.jpg') }}">
                                <div class="bg-cover"></div> 
                        </a> 
                         <div class="vd_info">
                  ...
                  <div class="gallery-item  filter-3">
                      <a href="img/photos/15.jpg" data-rel="prettyPhoto[2]"> 
                                <img alt="example image" src="{{ asset('/img/photos/15.jpg') }}">
                                <div class="bg-cover"></div> 
                        </a> 
                         <div class="vd_info">
                  ...
                  <div class="gallery-item  filter-1">
                      <a href="img/photos/02.jpg" data-rel="prettyPhoto[2]"> 
                                <img alt="example image" src="{{ asset('/img/photos/02.jpg') }}">
                                <div class="bg-cover"></div> 
                        </a> 
                         <div class="vd_info">
                  ...
                  <div class="gallery-item  filter-2">
                       <a href="img/photos/06.jpg" data-rel="prettyPhoto[2]"> 
                                <img alt="example image" src="{{ asset('/img/photos/06.jpg') }}">
                                <div class="bg-cover"></div> 
                        </a> 
                         <div class="vd_info">
                  ...
                  <div class="gallery-item  filter-2">
                       <a href="img/photos/04.jpg" data-rel="prettyPhoto[2]"> 
                                <img alt="example image" src="{{ asset('/img/photos/04.jpg') }}">
                                <div class="bg-cover"></div> 
                        </a> 
                         <div class="vd_info">
                  ...
                  <div class="gallery-item  filter-1">
                       <a href="img/photos/10.jpg" data-rel="prettyPhoto[2]"> 
                                <img alt="example image" src="{{ asset('/img/photos/10.jpg') }}">
                                <div class="bg-cover"></div> 
                        </a> 
                         <div class="vd_info">
                  ...
                  <div class="gallery-item   filter-3">
                       <a href="img/photos/09.jpg" data-rel="prettyPhoto[2]"> 
                                <img alt="example image" src="{{ asset('/img/photos/09.jpg') }}">
                                <div class="bg-cover"></div> 
                        </a> 
                         <div class="vd_info">
                  ...
                  <div class="gallery-item  filter-1">
                       <a href="img/photos/11.jpg" data-rel="prettyPhoto[2]"> 
                                <img alt="example image" src="{{ asset('/img/photos/11.jpg') }}">
                                <div class="bg-cover"></div> 
                        </a> 
                         <div class="vd_info">
                   ...
                   <div class="gallery-item  filter-1">
                       <a href="img/photos/12.jpg" data-rel="prettyPhoto[2]"> 
                                <img alt="example image" src="{{ asset('/img/photos/12.jpg') }}">
                                <div class="bg-cover"></div> 
                        </a> 
                           <div class="vd_info">
                   ...
                   <div class="gallery-item  filter-3">
                       <a href="img/photos/13.jpg" data-rel="prettyPhoto[2]"> 
                                <img alt="example image" src="{{ asset('/img/photos/13.jpg') }}">
                                <div class="bg-cover"></div> 
                        </a> 
                         <div class="vd_info">
                   ...
                   <div class="gallery-item  filter-2">
                       <a href="img/photos/14.jpg" data-rel="prettyPhoto[2]"> 
                                <img alt="example image" src="{{ asset('/img/photos/14.jpg') }}">
                                <div class="bg-cover"></div> 
                        </a> 
                         <div class="vd_info">
...
<ul class="list-wrapper">
                    <li> <a href="#"> 
                    		<span class="menu-icon"><img src="{{ asset('/img/avatar/avatar.jpg') }}" alt="example image"></span> 
                         </a>
                    ...
                    <li class="warning"> 
                    		<a href="#"> 
                    			<span class="menu-icon"><img src="{{ asset('/img/avatar/avatar-2.jpg') }}" alt="example image"></span>  
                            </a>                            
                    ...
                    <li> <a href="#"> 
                    		<span class="menu-icon"><img src="{{ asset('/img/avatar/avatar-3.jpg') }}" alt="example image"></span> 
                         </a>    
                    ...
                    <li> <a href="#"> 
                    		<span class="menu-icon"><img src="{{ asset('/img/avatar/avatar-4.jpg') }}" alt="example image"></span> 
                         </a>    
                    ...
                    <li> <a href="#"> 
                    		<span class="menu-icon"><img src="{{ asset('/img/avatar/avatar-5.jpg') }}" alt="example image"></span>  
                         </a>   
                    ...
                    <li> <a href="#"> 
                    		<span class="menu-icon"><img src="{{ asset('/img/avatar/avatar-6.jpg') }}" alt="example image"></span>
                         </a>    
                    ...
                    <li> <a href="#"> 
                    		<span class="menu-icon"><img src="{{ asset('/img/avatar/avatar-7.jpg') }}" alt="example image"></span> 
                         </a>   
                    ...
                    <li> <a href="#"> 
                    		<span class="menu-icon"><img src="{{ asset('/img/avatar/avatar-8.jpg') }}" alt="example image"></span>
                         </a>    
        	...
        	<div class="row">
            	<div class="col-xs-12 col-sm-6">
                    <div class="content-list content-large menu-action-right">
                        ...
                        <li>  
                            <div class="menu-icon"><a href="#"><img src="{{ asset('/img/groups/logo-01.jpg') }}" alt="example image"></a></div> 
                            <div class="menu-text"> 
            	...
            	<div class="col-xs-12 col-sm-6">
                    <div class="content-list content-large menu-action-right">
                        <ul class="list-wrapper pd-lr-15">
                        <li>  
                            <div class="menu-icon"><a href="#"><img src="{{ asset('/img/groups/logo-02.jpg') }}" alt="example image"></a></div> 
                            <div class="menu-text"> 
            	...
            	<div class="col-xs-12 col-sm-6">
                    <div class="content-list content-large menu-action-right">
                        <ul class="list-wrapper pd-lr-15">
                        <li>  
                            <div class="menu-icon"><a href="#"><img src="{{ asset('/img/groups/logo-03.jpg') }}" alt="example image"></a></div> 
                            <div class="menu-text"> 
