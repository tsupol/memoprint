      ...
      <div class="vd_top-menu-wrapper">
        <div class="container <?php if (isset($top_menu_extra_class)) { echo($top_menu_extra_class);}?>">
          ...
          <div class="vd_panel-header">
          	<div class="logo">
            	<a href="index.php"><img alt="logo" src="<?php if (isset($logo_path)) { echo(asset($logo_path));}?>"></a>
            </div>
            <!-- logo -->
          ...
          <div class="vd_container">
          	<div class="row">
                ...
                @include("igm/headers/menu-search")
                </div>
                <div class="col-sm-7 col-xs-12">
              		<div class="vd_mega-menu-wrapper">
                    	<div class="vd_mega-menu pull-right">

                    @include("igm/headers/menu-status")
                        </div>
                    </div>
                </div>
