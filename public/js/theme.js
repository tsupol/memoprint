...
jQuery(document).ready(function($)
	{
		...
		*/
		...
		$(window).load(function() {
				...
				$('body').on('click', '[data-action^="backtop"]', function(e){
						e.preventDefault();
            ...
            //$('body').on('DOMNodeInserted', '[data-rel^="scroll"]', function (e) {
            //    var target = $(e.target); //inserted element;
            //    console.log('56', target.innerHTML());
            //    if(target.attr('data-rel') == 'scroll') {
		...
		*/
		...
		$('body').on('click', '[data-action^="nav-left-medium"]', function() {	
			navbarResize('left','medium');		
			resizeAffixPanel();															
		});					
		$('body').on('click', '[data-action^="nav-left-small"]', function() {
			navbarResize('left','small');	
			resizeAffixPanel();																		
		});	
		
		$('body').on('click', '[data-action^="nav-right-medium"]', function() {	
			navbarResize('right','medium');	
			resizeAffixPanel();																		
		});					
		$('body').on('click', '[data-action^="nav-right-small"]', function() {
			navbarResize('right','small');	
			resizeAffixPanel();																	
		});																
		$('body').on('click', '[data-action^="toggle-navbar-left"]', function() {
			toggleNavbar('left');			
			resizeAffixPanel();							
		});			
		$('body').on('click', '[data-action^="toggle-navbar-right"]', function() {
			toggleNavbar('right');			
			resizeAffixPanel();										
		});			
...
//				$('[data-action^="fullscreen"]').addClass('active');								
		...
		*/			
		$('body').on('click', '[data-action^="click-trigger"]', function(e) {
			e.preventDefault();
		...
		$('body').on('click', '[data-action^="expand-all"]', function() {
		...
		$('body').on('click', '[data-action^="minimize"]', function() {
		...
		$('body').on('click', '[data-action^="chat-close"]', function() {
			$('.vd_chat-menu').remove();
		});
		...
		$('body').on('click', '[data-action^="notification"]', function(e){
				e.preventDefault();
